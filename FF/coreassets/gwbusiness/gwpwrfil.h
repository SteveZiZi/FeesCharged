 ...
 */
#ifndef __GWB_POWER_FILE_H__
#define __GWB_POWER_FILE_H__
#include "basedef.h"
#include "basetype.h"
#include "timeop.h"
#include "fileop.h"
...
/** @brief 记录保存条数定义 */
#define RECORD_STORE_DAY_MAX		62
#define RECORD_STORE_MON_MAX		12
#define RECORD_STORE_VIP_MAX		10
#define RECORD_STORE_CBR_MAX		62
 ...
 */
int  GW_GetVipFreezeIntervalM(INT8U FreezeCode);
...
public:
	...
	/** @brief 设置历史数据的存储长度 */
	short SetClass2FnLen(S_WORD Fn, short len);
