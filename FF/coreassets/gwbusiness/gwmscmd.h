 ...
 *  @version 0.1
 */
#ifndef __GWB_MSCMD_H__
#define __GWB_MSCMD_H__
#include "basedef.h"
#include "strings.h"
#include "bitsetex.h"
#include "basetype.h"
...
public:
	...
	/** @brief  获取FN对应的PN意义
	 *  @param[in] FN 国网要求二类数据FN
	 *  @return GW_CLASS2PN_UNKNOW, GW_CLASS2PN_MPOINT, GW_CLASS2PN_MPOINT_STAT, GW_CLASS2PN_GROUP, GW_CLASS2PN_PORT, GW_CLASS2PN_TERM
	 */
	static int GetPnMean4Class2Fn(S_WORD FN);

	/** @brief  获取FN对应的PN意义
	 *  @param[in] FN 国网要求一类数据FN
	 *  @return GW_CLASS2PN_UNKNOW, GW_CLASS2PN_MPOINT, GW_CLASS2PN_MPOINT_STAT, GW_CLASS2PN_GROUP, GW_CLASS2PN_PORT, GW_CLASS2PN_TERM
	 */
	static int GetPnMean4Class1Fn(S_WORD FN);
};
...
enum
{
	...
	FRAME_PROCESS_RESPONSE_SECURITY,
	FRAME_PROCESS_PWD_ERROR,
