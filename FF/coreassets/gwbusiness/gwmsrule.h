...
public:
	...
	int ExtractAuthenticateInfo(const string &strCmd, string &strAuthenticateInfo);
	...
	int MakeSecurityConfirmCmd(const string &strInfo, string &strConfirm);
//	int MakeSecurityConfirmCmd(S_BYTE ErrorCode, const string &strInfo, string &strConfirm);
