...
#define CONS_CARD_EASM_RAM_LEN  8//8字节模块ESAM随机数

#define CONS_CARD_DST_DATA_LEN  8//8字节密文

#define CONS_CARD_RECHARGE_VAL_LEN  4//4字节充值金额 4字节充值次数

#define CONS_CARD_MAC_LEN	4//4字节MAC

#define CONS_CARD_CUSTOMERNO_LEN  6//6字节

#define CONS_CARD_BACKINFO_LEN	  50 // 50字节返写内容

#define CONS_METER_ESAM_RAND_LEN	8 // 8字节表端ESAM随机数

#define CONS_METER_RAND_LEN	4	// 4字节表端随机数
...
{
	NONE_TRACE = 0,
	LONG_DISTANCE_ACCOUNT,
	LOCAL_ACCOUNT,
	WALLET_CHARGE,
	WALLET_INIT,
	PARAM_UPDATE,
	LONG_DISTANCE_CONTROL
}T_emTraceType;
...
struct SIpcDeviceRegData
{
	...
	unsigned char m_RelayState;//继电器状态0:通1:断	
};
